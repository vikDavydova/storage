...
export const OptionsMenu = (_a) => {
    ...
    ref, menuAppendTo = 'inline', ouiaId, ouiaSafe = true, zIndex = 9999 } = _a, props = __rest(_a, ["className", "menuItems", "toggle", "isText", "isGrouped", "id", "ref", "menuAppendTo", "ouiaId", "ouiaSafe", "zIndex"]);
    return (React.createElement(DropdownContext.Provider, { value: {
        ...
        React.createElement(DropdownWithContext, Object.assign({ id: id, dropdownItems: menuItems, className: className, isGrouped: isGrouped, toggle: toggle, menuAppendTo: menuAppendTo, zIndex: zIndex }, props))));
};

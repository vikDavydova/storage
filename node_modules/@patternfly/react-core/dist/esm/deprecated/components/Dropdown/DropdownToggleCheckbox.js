...
class DropdownToggleCheckbox extends React.Component {
    ...
    render() {
        ...
        const spinner = (React.createElement(Spinner, { diameter: "1em", "aria-valuetext": defaultProgressAriaValueText, "aria-live": "polite", "aria-label": defaultProgressAriaLabel }));

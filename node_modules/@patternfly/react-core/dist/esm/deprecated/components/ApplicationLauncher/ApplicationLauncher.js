    ...
    constructor() {
        ...
        this.createSearchBox = () => {
            ...
            return (React.createElement("div", { key: "search", className: css(styles.appLauncherMenuSearch) },
                React.createElement(ApplicationLauncherItem, { customChild: React.createElement(SearchInput, Object.assign({ placeholder: searchPlaceholderText, onChange: onSearch }, searchProps)) })));
        };
    }
    render() {
        ...
        favoritesLabel, searchNoResultsText, menuAppendTo, zIndex = 9999 } = _a, props = __rest(_a, ['aria-label', "isOpen", "onToggle", "toggleIcon", "toggleId", "onSelect", "isDisabled", "className", "isGrouped", "favorites", "onFavorite", "onSearch", "items", "searchPlaceholderText", "searchProps", "ref", "favoritesLabel", "searchNoResultsText", "menuAppendTo", "zIndex"]);
        let renderableItems = [];
        if (onFavorite) {
            let favoritesGroup = [];

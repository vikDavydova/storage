...
export declare const PageNavigation: {
    ({ className, children, isWidthLimited, stickyOnBreakpoint, hasShadowTop, hasShadowBottom, hasOverflowScroll, "aria-label": ariaLabel, ...props }: PageNavigationProps): JSX.Element;
    displayName: string;
};

...
class DropdownToggleCheckbox extends React.Component {
    constructor(props) {
        ...
        this.handleChange = (event) => {
            var _a, _b;
            (_b = (_a = this.props).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, event, event.target.checked);
        };
    ...
    render() {
        ...
        const spinner = (React.createElement(Spinner_1.Spinner, { diameter: "1em", "aria-valuetext": defaultProgressAriaValueText, "aria-live": "polite", "aria-label": defaultProgressAriaLabel }));

...
class ContextSelectorToggle extends React.Component {
    constructor() {
        ...
        this.onEscPress = (event) => {
            ...
            if (isOpen && event.key === constants_1.KeyTypes.Escape) {
                onToggle(null, false);
                this.toggle.current.focus();
            }
        };
        this.onKeyDown = (event) => {
            ...
            if ((event.key === constants_1.KeyTypes.Tab && !isOpen) || event.key !== constants_1.KeyTypes.Enter) {
                return;
            }
            ...
            else if ((event.key === constants_1.KeyTypes.Enter || event.key === ' ') && !isOpen) {
                onToggle(null, !isOpen);
                onEnter();
            }
        };
    ...
    render() {
        ...
        return (React.createElement("button", Object.assign({}, props, { id: id, ref: this.toggle, className: (0, react_styles_1.css)(context_selector_1.default.contextSelectorToggle, isActive && context_selector_1.default.modifiers.active, isPlain && context_selector_1.default.modifiers.plain, isText && context_selector_1.default.modifiers.text, className), type: "button", onClick: (event) => onToggle(event, !isOpen), "aria-expanded": isOpen, onKeyDown: this.onKeyDown }),
            React.createElement("span", { className: (0, react_styles_1.css)(context_selector_1.default.contextSelectorToggleText) }, toggleText),
            React.createElement("span", { className: (0, react_styles_1.css)(context_selector_1.default.contextSelectorToggleIcon) },

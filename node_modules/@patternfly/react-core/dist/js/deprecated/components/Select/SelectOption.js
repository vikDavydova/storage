...
class SelectOption extends React.Component {
    ...
    render() {
        ...
        const generatedId = id || (0, util_1.getUniqueId)('select-option');
        const favoriteButton = (onFavorite) => (React.createElement("button", { className: (0, react_styles_1.css)(select_1.default.selectMenuItem, select_1.default.modifiers.action, select_1.default.modifiers.favoriteAction), "aria-label": isFavorite ? ariaIsFavoriteLabel : ariaIsNotFavoriteLabel, onClick: () => {
                onFavorite(generatedId.replace('favorite-', ''), isFavorite);
            }, onKeyDown: (event) => {
                this.onKeyDown(event, 1, () => onFavorite(generatedId.replace('favorite-', ''), isFavorite));
            }, ref: this.favoriteRef },
            React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemActionIcon) },
                React.createElement(star_icon_1.default, null))));
        const itemDisplay = itemCount ? (React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemRow) },
            React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemText) }, children || (value && value.toString && value.toString())),
            React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemCount) }, itemCount))) : (children || value.toString());
        ...
        const renderOption = (onSelect, onClose, variant, inputIdPrefix, onFavorite, shouldResetOnSelect) => {
            if (variant !== selectConstants_1.SelectVariant.checkbox && isLoading && isGrouped) {
                return (React.createElement("div", { role: "presentation", className: (0, react_styles_1.css)(select_1.default.selectListItem, isLoading && select_1.default.modifiers.loading, className) }, children));
            }
            else if (variant !== selectConstants_1.SelectVariant.checkbox && isLoad && isGrouped) {
                return (React.createElement("div", null,
                    React.createElement("button", Object.assign({}, props, { role: "presentation", className: (0, react_styles_1.css)(select_1.default.selectMenuItem, select_1.default.modifiers.load, className), onClick: (event) => {
                ...
                return (React.createElement("li", { id: generatedId, role: "presentation", className: (0, react_styles_1.css)(isLoading && select_1.default.selectListItem, !isLoading && select_1.default.selectMenuWrapper, isFavorite && select_1.default.modifiers.favorite, isFocused && select_1.default.modifiers.focus, isLoading && select_1.default.modifiers.loading), ref: this.liRef },
                    ...
                    !isLoading && !isLoad && (React.createElement(React.Fragment, null,
                        React.createElement(Component, Object.assign({}, props, { className: (0, react_styles_1.css)(select_1.default.selectMenuItem, isLoad && select_1.default.modifiers.load, isSelected && select_1.default.modifiers.selected, isDisabled && select_1.default.modifiers.disabled, description && select_1.default.modifiers.description, isFavorite !== null && select_1.default.modifiers.link, className), onClick: (event) => {
                                if (!isDisabled) {
                                    onClick(event);
                            ...
                            description && (React.createElement(React.Fragment, null,
                                React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemMain) },
                                    itemDisplay,
                                    isSelected && (React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemIcon) },
                                        React.createElement(check_icon_1.default, { "aria-hidden": true })))),
                                React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemDescription) }, description))),
                            !description && (React.createElement(React.Fragment, null,
                                itemDisplay,
                                isSelected && (React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectMenuItemIcon) },
                                    React.createElement(check_icon_1.default, { "aria-hidden": true })))))),
                ...
                return (React.createElement("button", { className: (0, react_styles_1.css)(select_1.default.selectMenuItem, select_1.default.modifiers.load, isFocused && select_1.default.modifiers.focus, className), onKeyDown: (event) => {
                ...
                return (React.createElement("div", { className: (0, react_styles_1.css)(select_1.default.selectListItem, isLoading && select_1.default.modifiers.loading, className) }, children));
            }
            else if (variant === selectConstants_1.SelectVariant.checkbox && !isNoResultsOption && !isLoading && !isLoad) {
                return (React.createElement("label", Object.assign({}, props, { className: (0, react_styles_1.css)(check_1.default.check, select_1.default.selectMenuItem, isDisabled && select_1.default.modifiers.disabled, description && select_1.default.modifiers.description, className), onKeyDown: (event) => {
                        this.onKeyDown(event, 0, undefined, true);
                    } }),
                    React.createElement("input", { id: inputId || `${inputIdPrefix}-${value.toString()}`, className: (0, react_styles_1.css)(check_1.default.checkInput), type: "checkbox", onChange: (event) => {
                            if (!isDisabled) {
                                onClick(event);
                                onSelect(event, value);
                            }
                        }, ref: this.ref, checked: isChecked || false, disabled: isDisabled }),
                    React.createElement("span", { className: (0, react_styles_1.css)(check_1.default.checkLabel, isDisabled && select_1.default.modifiers.disabled) }, itemDisplay),
                    description && React.createElement("div", { className: (0, react_styles_1.css)(check_1.default.checkDescription) }, description)));
            }
            else if (variant === selectConstants_1.SelectVariant.checkbox && isNoResultsOption && !isLoading && !isLoad) {
                return (React.createElement("div", null,
                    React.createElement(Component, Object.assign({}, props, { className: (0, react_styles_1.css)(select_1.default.selectMenuItem, isSelected && select_1.default.modifiers.selected, isDisabled && select_1.default.modifiers.disabled, className), role: "option", "aria-selected": isSelected || null, ref: this.ref, onKeyDown: (event) => {
                            this.onKeyDown(event, 0, undefined, true);
                        }, type: "button" }), itemDisplay)));
            }
        };

    ...
    constructor(props) {
        ...
        this.handleGlobalKeys = (event) => {
            ...
            if (isOpen && event.key === constants_1.KeyTypes.Tab && hasFooter) {
                const tabbableItems = (0, util_1.findTabbableElements)(footerRef, selectConstants_1.SelectFooterTabbableItems);
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            !isTypeahead && (React.createElement("button", Object.assign({}, props, toggleProps, { ref: this.toggle, type: type, className: (0, react_styles_1.css)(select_1.default.selectToggle, hasPlaceholderStyle && select_1.default.modifiers.placeholder, isDisabled && select_1.default.modifiers.disabled, isPlain && select_1.default.modifiers.plain, isActive && select_1.default.modifiers.active, className), "aria-label": ariaLabel, onBlur: onBlur, 
                ...
                children,
                React.createElement("span", { className: (0, react_styles_1.css)(select_1.default.selectToggleArrow) }, toggleIndicator !== null && toggleIndicator !== void 0 ? toggleIndicator : React.createElement(caret_down_icon_1.default, null)))),
            isTypeahead && (React.createElement("div", Object.assign({}, props, { ref: this.toggle, className: (0, react_styles_1.css)(select_1.default.selectToggle, hasPlaceholderStyle && select_1.default.modifiers.placeholder, isDisabled && select_1.default.modifiers.disabled, isPlain && select_1.default.modifiers.plain, isTypeahead && select_1.default.modifiers.typeahead, className), onBlur: onBlur, 
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
                onClick: (event) => {
                    if (!isDisabled) {
                        onToggle(event, !isOpen);
                ...
                children,
                React.createElement("button", Object.assign({}, toggleProps, { type: type, className: (0, react_styles_1.css)(button_1.default.button, select_1.default.selectToggleButton, select_1.default.modifiers.plain), "aria-label": ariaLabel, onClick: (event) => {
                        onToggle(event, !isOpen);
                        if (isOpen) {
                            onClose();
                        }
                    ...
                    tabIndex: -1
                }), { disabled: isDisabled }), toggleIndicator !== null && toggleIndicator !== void 0 ? toggleIndicator : React.createElement(caret_down_icon_1.default, { className: (0, react_styles_1.css)(select_1.default.selectToggleArrow) }))))));
    }
}
...
exports.SelectToggle = React.forwardRef((props, ref) => (React.createElement(SelectToggleBase, Object.assign({ innerRef: ref }, props))));

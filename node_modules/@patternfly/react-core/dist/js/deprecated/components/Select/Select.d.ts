...
import { ChipGroupProps } from '../../../components/Chip';
...
export interface SelectProps extends Omit<React.HTMLProps<HTMLDivElement>, 'onSelect' | 'ref' | 'checked' | 'selected'>, OUIAProps {
...
declare class Select extends React.Component<SelectProps & OUIAProps, SelectState> {
    ...
    onEnter: () => void;
    onToggle: (e: React.MouseEvent | React.ChangeEvent | React.KeyboardEvent | Event, isExpanded: boolean) => void;
    onClose: () => void;

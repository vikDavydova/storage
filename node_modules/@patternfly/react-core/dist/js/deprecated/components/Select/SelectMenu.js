...
class SelectMenuWithRef extends React.Component {
    ...
    extendCheckboxChildren(children) {
        ...
        if (isGrouped) {
            return React.Children.map(children, (group) => {
                ...
                return React.cloneElement(group, {
                    titleId: group.props.label && group.props.label.replace(/\W/g, '-'),
                    children: group.props.children ? (React.createElement("fieldset", { "aria-labelledby": group.props.label && group.props.label.replace(/\W/g, '-'), className: (0, react_styles_1.css)(select_1.default.selectMenuFieldset) }, React.Children.map(group.props.children, (option) => option.type === Divider_1.Divider
                        ? option
    ...
    renderSelectMenu({ variant, inputIdPrefix }) {
        ...
        let Component = 'div';
        const variantProps = Object.assign({ ref: innerRef, className: (0, react_styles_1.css)(!footer ? select_1.default.selectMenu : 'pf-v5-c-select__menu-list', position === selectConstants_1.SelectPosition.right && select_1.default.modifiers.alignRight, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }));
        ...
        if (isCustomContent) {
            ...
            if (React.Children.count(children) === 0) {
                variantProps.children = React.createElement("fieldset", { className: (0, react_styles_1.css)(select_1.default.selectMenuFieldset) });
            }
            else {
                variantProps.children = (React.createElement("fieldset", { "aria-label": ariaLabel, "aria-labelledby": (!ariaLabel && ariaLabelledBy) || null, className: (0, react_styles_1.css)(form_1.default.formFieldset) },
                    children.shift(),
                    extendedChildren()));
            }
        }
        ...
        return (React.createElement(React.Fragment, null,
            ...
            footer && (React.createElement("div", { className: (0, react_styles_1.css)(select_1.default.selectMenuFooter), ref: footerRef }, footer))));
    }
    render() {

...
class ApplicationLauncher extends React.Component {
    constructor() {
        ...
        this.createSearchBox = () => {
            ...
            return (React.createElement("div", { key: "search", className: (0, react_styles_1.css)(app_launcher_1.default.appLauncherMenuSearch) },
                React.createElement(ApplicationLauncherItem_1.ApplicationLauncherItem, { customChild: React.createElement(SearchInput_1.SearchInput, Object.assign({ placeholder: searchPlaceholderText, onChange: onSearch }, searchProps)) })));
        };
    }
    render() {
        ...
        favoritesLabel, searchNoResultsText, menuAppendTo, zIndex = 9999 } = _a, props = tslib_1.__rest(_a, ['aria-label', "isOpen", "onToggle", "toggleIcon", "toggleId", "onSelect", "isDisabled", "className", "isGrouped", "favorites", "onFavorite", "onSearch", "items", "searchPlaceholderText", "searchProps", "ref", "favoritesLabel", "searchNoResultsText", "menuAppendTo", "zIndex"]);
        let renderableItems = [];
        if (onFavorite) {
            let favoritesGroup = [];
            let renderableFavorites = [];
            if (favorites.length > 0) {
                renderableFavorites = (0, favorites_1.createRenderableFavorites)(items, isGrouped, favorites, true);
                favoritesGroup = [
            ...
            if (renderableFavorites.length > 0) {
                renderableItems = favoritesGroup.concat((0, favorites_1.extendItemsWithFavorite)(items, isGrouped, favorites));
            }
            else {
                renderableItems = (0, favorites_1.extendItemsWithFavorite)(items, isGrouped, favorites);
            }
        }
        else {
...
ApplicationLauncher.defaultProps = {
    ...
    onToggle: (_event, _value) => undefined,
    /* eslint-enable @typescript-eslint/no-unused-vars */

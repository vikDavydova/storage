...
const OptionsMenuItemGroup = (_a) => {
    ...
    return (React.createElement("section", Object.assign({}, props, { className: (0, react_styles_1.css)(options_menu_1.default.optionsMenuGroup), role: "none" }),
        groupTitle && React.createElement("h1", { className: (0, react_styles_1.css)(options_menu_1.default.optionsMenuGroupTitle) }, groupTitle),

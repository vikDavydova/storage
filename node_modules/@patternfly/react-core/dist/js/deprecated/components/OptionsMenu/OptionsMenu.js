...
const OptionsMenu = (_a) => {
    ...
    ref, menuAppendTo = 'inline', ouiaId, ouiaSafe = true, zIndex = 9999 } = _a, props = tslib_1.__rest(_a, ["className", "menuItems", "toggle", "isText", "isGrouped", "id", "ref", "menuAppendTo", "ouiaId", "ouiaSafe", "zIndex"]);
    return (React.createElement(Dropdown_1.DropdownContext.Provider, { value: {
            ...
            baseComponent: 'div',
            ouiaId: (0, helpers_1.useOUIAId)(exports.OptionsMenu.displayName, ouiaId),
            ouiaSafe,
            ouiaComponentType: exports.OptionsMenu.displayName
        } },
        React.createElement(DropdownWithContext_1.DropdownWithContext, Object.assign({ id: id, dropdownItems: menuItems, className: className, isGrouped: isGrouped, toggle: toggle, menuAppendTo: menuAppendTo, zIndex: zIndex }, props))));
};

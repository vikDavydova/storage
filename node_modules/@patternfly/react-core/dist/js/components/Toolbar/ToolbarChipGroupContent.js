...
class ToolbarChipGroupContent extends React.Component {
    render() {
        ...
        return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(toolbar_1.default.toolbarContent, !isHidden && !collapseListedFilters && toolbar_1.default.modifiers.chipContainer, isHidden && toolbar_1.default.modifiers.hidden, className) }, ((numberOfFilters === 0 || isExpanded) && { hidden: true }), { ref: chipGroupContentRef }, props),

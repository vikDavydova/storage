...
useMemo }) => {
    ...
    const renderNodeContent = () => {
        const content = (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            isSelectable ? (react_1.default.createElement("button", { tabIndex: -1, className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeText) }, name)) : (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeText) }, name))));
    ...
    return (react_1.default.createElement("li", Object.assign({ id: id, className: (0, react_styles_1.css)(tree_view_1.default.treeViewListItem, internalIsExpanded && tree_view_1.default.modifiers.expanded) }, (internalIsExpanded && { 'aria-expanded': 'true' }), { role: "treeitem", tabIndex: -1 }),
        react_1.default.createElement("div", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewContent) },
            react_1.default.createElement(GenerateId_1.GenerateId, { prefix: isSelectable ? 'selectable-id' : 'checkbox-id' }, (randomId) => (react_1.default.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(tree_view_1.default.treeViewNode, children && (isSelectable || hasCheckbox) && tree_view_1.default.modifiers.selectable, (!children || isSelectable) &&
                    activeItems &&

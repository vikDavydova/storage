...
const DatePickerBase = (_a, ref) => {
    ...
    const style = Object.assign({ '--pf-v5-c-date-picker__input--c-form-control--width-chars': widthChars }, styleProps);
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(date_picker_1.default.datePicker, className), ref: datePickerWrapperRef, style: style }, props),
        React.createElement(Popover_1.Popover, Object.assign({ elementToFocus: valueDate ? focusSelectorForSelectedDate : focusSelectorForUnselectedDate, position: "bottom", bodyContent: React.createElement(CalendarMonth_1.CalendarMonth, { date: valueDate, onChange: onDateClick, locale: locale, 

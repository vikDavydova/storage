...
const LoginMainFooterLinksItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)(login_1.default.loginMainFooterLinksItem, className) }, props),
        React.createElement(LinkComponent, Object.assign({ className: (0, react_styles_1.css)(login_1.default.loginMainFooterLinksItemLink), href: href, target: target }, linkComponentProps), children)));
};

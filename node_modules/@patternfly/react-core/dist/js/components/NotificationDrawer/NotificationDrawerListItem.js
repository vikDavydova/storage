...
const NotificationDrawerListItem = (_a) => {
    ...
    onClick = (event) => undefined, tabIndex = 0, variant = 'custom' } = _a, props = tslib_1.__rest(_a, ["children", "className", "isHoverable", "isRead", "onClick", "tabIndex", "variant"]);
    const onKeyDown = (event) => {
        if (!event.target.parentElement.classList.contains('pf-v5-c-notification-drawer__list-item-action')) {

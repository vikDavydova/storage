...
const NotificationDrawerHeader = (_a) => {
    ...
    return (React.createElement("div", Object.assign({}, props, { className: (0, react_styles_1.css)(notification_drawer_1.default.notificationDrawerHeader, className) }),
        React.createElement(Text_1.Text, { component: Text_1.TextVariants.h1, className: (0, react_styles_1.css)(notification_drawer_1.default.notificationDrawerHeaderTitle) }, title),
        (customText !== undefined || count !== undefined) && (React.createElement("span", { className: (0, react_styles_1.css)(notification_drawer_1.default.notificationDrawerHeaderStatus) }, customText || `${count} ${unreadText}`)),

...
const CalendarMonth = (_a) => {
    ...
    const getInitialDate = () => {
        ...
        if ((0, datetimeUtils_1.isValidDate)(initDate)) {
            ...
            return (0, datetimeUtils_1.isValidDate)(rangeStart) ? rangeStart : today;
        }
    };
    ...
    const yearHasFebruary29th = (year) => new Date(year, 1, 29).getMonth() === 1;
    const dateIsFebruary29th = (date) => date.getMonth() === 1 && date.getDate() === 29;
            ...
            react_1.default.createElement(InputGroup_1.InputGroup, null,
                ...
                react_1.default.createElement(InputGroup_1.InputGroupItem, null,
                    react_1.default.createElement("div", { className: calendar_month_1.default.calendarMonthHeaderYear },
                        react_1.default.createElement(TextInput_1.TextInput, { "aria-label": yearInputAriaLabel, type: "number", value: yearFormatted, onChange: (ev, year) => {
                                const newDate = new Date(focusedDate);

...
const Banner = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(banner_1.default.banner, banner_1.default.modifiers[variant], isSticky && banner_1.default.modifiers.sticky, className) }, props),

...
class SimpleListItem extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(SimpleList_1.SimpleListContext.Consumer, null, ({ currentRef, updateCurrentRef, isControlled }) => {
            ...
            return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)('pf-v5-c-simple-list__item', className) }, props),
                React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(simple_list_1.default.simpleListItemLink, isCurrentItem && simple_list_1.default.modifiers.current, componentClassName), onClick: (evt) => {
                        onClick(evt);

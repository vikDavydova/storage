...
const Accordion = (_a) => {
    ...
    return (React.createElement(AccordionList, Object.assign({ className: (0, react_styles_1.css)(accordion_1.default.accordion, isBordered && accordion_1.default.modifiers.bordered, displaySize === 'lg' && accordion_1.default.modifiers.displayLg, className), "aria-label": ariaLabel }, (!asDefinitionList && ariaLabel && { role: 'region' }), props),

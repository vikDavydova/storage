...
const chip_group_1 = tslib_1.__importDefault(require("@patternfly/react-styles/css/components/Chip/chip-group"));
...
class ChipGroup extends React.Component {
    ...
    renderLabel(id) {
        ...
        return isTooltipVisible ? (React.createElement(Tooltip_1.Tooltip, { position: tooltipPosition, content: categoryName },
            React.createElement("span", { tabIndex: 0, ref: this.headingRef, className: (0, react_styles_1.css)(chip_group_1.default.chipGroupLabel) },
                React.createElement("span", { id: id }, categoryName)))) : (React.createElement("span", { ref: this.headingRef, className: (0, react_styles_1.css)(chip_group_1.default.chipGroupLabel), id: id }, categoryName));
    }
    render() {
        ...
        const renderChipGroup = (id) => {
            ...
            return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(chip_group_1.default.chipGroup, className, categoryName && chip_group_1.default.modifiers.category), role: "group" }, (categoryName && { 'aria-labelledby': id }), (!categoryName && { 'aria-label': ariaLabel }), (0, helpers_2.getOUIAProps)(ChipGroup.displayName, ouiaId)),
                React.createElement("div", { className: (0, react_styles_1.css)(chip_group_1.default.chipGroupMain) },
                    categoryName && this.renderLabel(id),
                    React.createElement("ul", Object.assign({ className: (0, react_styles_1.css)(chip_group_1.default.chipGroupList) }, (categoryName && { 'aria-labelledby': id }), (!categoryName && { 'aria-label': ariaLabel }), { role: "list" }, rest),
                        chipArray.map((child, i) => (React.createElement("li", { className: (0, react_styles_1.css)(chip_group_1.default.chipGroupListItem), key: i }, child))),
                        numChildren > numChips && (React.createElement("li", { className: (0, react_styles_1.css)(chip_group_1.default.chipGroupListItem) },
                ...
                isClosable && (React.createElement("div", { className: (0, react_styles_1.css)(chip_group_1.default.chipGroupClose) },

...
const Brand = (_a) => {
    ...
    if (widths !== undefined) {
        responsiveStyles = Object.assign({}, (0, helpers_1.setBreakpointCssVars)(widths, '--pf-v5-c-brand--Width'));
    }
    if (heights !== undefined) {
        responsiveStyles = Object.assign(Object.assign({}, responsiveStyles), (0, helpers_1.setBreakpointCssVars)(heights, '--pf-v5-c-brand--Height'));
    }
    return (
